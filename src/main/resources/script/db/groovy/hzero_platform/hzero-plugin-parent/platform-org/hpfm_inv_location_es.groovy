...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_inv_location_es.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_inv_location_es") {
        ...
        createTable(tableName: "hpfm_inv_location_es", remarks: "货位关联表") {
            column(name: "location_es_id", type: "bigint", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "external_system_code", type: "varchar(" + 30 * weight + ")",  remarks: "外部系统代码")  {constraints(nullable:"false")}  
            column(name: "location_id", type: "bigint",  remarks: "hzero平台货位id")  {constraints(nullable:"false")}  
    ...
    changeSet(author: "hzero@hand-china.com", id: "2019-07-19-hpfm_inv_location_es") {
        def weight = 1
        if(helper.isSqlServer()){
            weight = 2
        } else if(helper.isOracle()){
        ...
        addColumn(tableName: 'hpfm_inv_location_es') {
