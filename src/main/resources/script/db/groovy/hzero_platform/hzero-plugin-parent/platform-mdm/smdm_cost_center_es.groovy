...
databaseChangeLog(logicalFilePath: 'script/db/smdm_cost_center_es.groovy') {
    ...
    changeSet(author: "hzero@hand-china.com", id: "smdm_cost_center_es-2021-07-08-version-2") {
        addUniqueConstraint(tableName: "smdm_cost_center_es", columnNames: "cost_id,external_system_code", constraintName: "smdm_cost_center_es_u1")
    }
}
