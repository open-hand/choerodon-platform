...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_cusz_unit_field.groovy') {
    ...
    changeSet(author: "yupeng@goning-link.com", id: "2021-04-12_hpfm_cusz_unit_field_modify-defaultValue") {
        addDefaultValue(tableName: 'hpfm_cusz_unit_field', columnName: 'default_active', defaultValue: '-1')
    }

    changeSet(author: "yupeng@going-link.com", id: "2021-04-19_hpfm_cusz_unit_field_addColumns") {
        addColumn(tableName: 'hpfm_cusz_unit_field') {
    ...
    changeSet(author: "yupeng@going-link.com", id: "2021-04-19_hpfm_cusz_unit_field_addColumns-where_option") {
        addColumn(tableName: 'hpfm_cusz_unit_field') {
            column(name: "where_option", type: "varchar(" + 255 * weight + ")", remarks: "where条件运算符")
        }
    }

    changeSet(author: "yupeng@going-link.com", id: "2021-04-20_hpfm_cusz_unit_field_tl_createTable") {
        createTable(tableName: "hpfm_cusz_unit_field_tl") {
