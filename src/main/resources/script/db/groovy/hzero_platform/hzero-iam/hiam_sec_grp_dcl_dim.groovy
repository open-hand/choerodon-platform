...
databaseChangeLog(logicalFilePath: 'script/db/hiam_sec_grp_dcl_dim.groovy') {
    ...
    changeSet(author: "Admin@hand-china.com", id: "hiam_sec_grp_dcl_dim-2021-06-22-version-2") {
        dropColumn (tableName: "hiam_sec_grp_dcl_dim", columnName: "assign_type_code")
        if (helper.isSqlServer()) {
            dropDefaultValue (tableName: "hiam_sec_grp_dcl_dim", columnName: "auto_assign_flag", columnDataType: "tinyint")
        }
        dropColumn (tableName: "hiam_sec_grp_dcl_dim", columnName: "auto_assign_flag")
    }
}
