...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_template_config.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-05-19-hpfm_template_config") {
        def weight = 1
        ...
        createTable(tableName: "hpfm_template_config", remarks: "模板配置") {
            column(name: "config_id", type: "bigint(20)", autoIncrement: true ,   remarks: "")  {constraints(primaryKey: true)} 
            column(name: "template_assign_id", type: "bigint(20)",  remarks: "模板配置ID，hpfm_template_assign.template_assign_id")  {constraints(nullable:"false")}  
            ...
            column(name: "order_seq", type: "int(11)",   defaultValue:"1",   remarks: "排序标识，用于为配置排序")  {constraints(nullable:"false")}  
            column(name: "tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID,hpfm_tenant")  {constraints(nullable:"false")}  
