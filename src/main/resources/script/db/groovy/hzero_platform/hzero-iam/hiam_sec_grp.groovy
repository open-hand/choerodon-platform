...
databaseChangeLog(logicalFilePath: 'script/db/hiam_sec_grp.groovy') {
    ...
    changeSet(author: "Admin@hand-china.com", id: "hiam_sec_grp-2021-06-22-version-2") {
        addColumn (tableName: "hiam_sec_grp") {
            column (name: "sec_grp_hierarchy", type: "tinyint", remarks: "安全组层级，0-多级，1-单级", afterColumn: "created_by", defaultValue: "0") {
