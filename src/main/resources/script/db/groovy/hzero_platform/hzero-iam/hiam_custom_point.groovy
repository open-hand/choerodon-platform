...
databaseChangeLog(logicalFilePath: 'script/db/hiam_custom_point.groovy') {
    changeSet(author: "hzero", id: "2019-12-16-hiam_custom_point") {
        ...
        createTable(tableName: "hiam_custom_point", remarks: "客户化端点") {
            column(name: "custom_point_id", type: "bigint", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "priority", type: "int",   defaultValue:"0",   remarks: "优先级")  {constraints(nullable:"false")}  
