...
databaseChangeLog(logicalFilePath: 'script/db/hiam_role_authority.groovy') {
    ...
    changeSet(author: "Admin@hand-china.com", id: "hiam_role_authority-2021-06-22-version-2") {
        dropNotNullConstraint (tableName: "hiam_role_authority", columnName: "data_source", columnDataType: "varchar(" + 30* weight_c + ")")
        //mysql在删除非空约束时候会清空默认值
        if (helper.isMysql()) {
            addDefaultValue (tableName: "hiam_role_authority", columnName: "data_source", columnDataType: "varchar(" + 30* weight_c + ")", defaultValue: "DEFAULT")
        }
    }
}
