...
databaseChangeLog(logicalFilePath: 'script/db/hiam_sec_grp_acl_field.groovy') {
    ...
    changeSet(author: "Admin@hand-china.com", id: "hiam_sec_grp_acl_field-2021-06-22-version-2") {
        dropColumn (tableName: "hiam_sec_grp_acl_field", columnName: "assign_type_code")
        if (helper.isSqlServer()) {
            dropDefaultValue (tableName: "hiam_sec_grp_acl_field", columnName: "auto_assign_flag", columnDataType: "tinyint")
        }
        dropColumn (tableName: "hiam_sec_grp_acl_field", columnName: "auto_assign_flag")
    }
}
