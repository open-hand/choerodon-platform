...
databaseChangeLog(logicalFilePath: 'script/db/hiam_role_authority_line.groovy') {
    ...
    changeSet(author: "Admin@hand-china.com", id: "hiam_role_authority_line-2021-06-22-version-2") {
        dropNotNullConstraint (tableName: "hiam_role_authority_line", columnName: "data_source", columnDataType: "varchar(" + 30* weight_c + ")")
        //mysql在删除非空约束时候会清空默认值
        if (helper.isMysql()) {
            addDefaultValue (tableName: "hiam_role_authority_line", columnName: "data_source", columnDataType: "varchar(" + 30* weight_c + ")", defaultValue: "DEFAULT")
        }
    }
}
