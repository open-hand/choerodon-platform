...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_permission_range.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2019-03-01-hpfm_permission_range") {
        ...
        createTable(tableName: "hpfm_permission_range", remarks: "屏蔽范围") {
            ...
            column(name: "sql_id", type: "varchar(" + 240 * weight + ")",  remarks: "屏蔽sqlId")   
    ...
    changeSet(author: "xiaoyu.zhao@hand-china.com", id: "2021-03-26-hpfm_permission_range") {
        def weight = 1
        if(helper.isSqlServer()){
            weight = 2
        } else if(helper.isOracle()){
        ...
        modifyDataType (tableName: "hpfm_permission_range", columnName: "service_name", newDataType: "varchar(" + 240 * weight + ")")
    }
}
